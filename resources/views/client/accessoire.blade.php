...
<main class="container">
  <div class="p-5 p-md-5 mb-5 rounded" style ='background-color:#292625;'>
    ...
    <img class="bd-placeholder-img  rounded " style ='background-color:#FFFFFF;' width="120" height="120" src="{{asset('images/client/Accessoire.jpg')}}"><br><br>
      <h2 class=" fst-italic">Accessoire</h2>
    </div>
  </div>
