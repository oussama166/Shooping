        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update-produit-admin',$produits->code) }}" method="POST"
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" id="photoprofil" class="form-control" name="photoprofil"
                                    value="{{$produits->photoprofil}}" autofocus>
                                <img style="width: 70px ;height: 70px"
                                    src="{{asset('images/produit-profil/'.$produits->photoprofil)}}">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="file" id="photo" class="form-control" value="{{$produits->photo}}"
                                    name="photo" autofocus>
                                <img style="width: 70px ;height: 70px"
                                    src="{{asset('images/produit/'.$produits->photo)}}">
                                @if ($errors->has('photo'))
                            ...
                            <div class="form-group mb-3 oui msg" id="div_cacher" style="display:none">
                                ...
                                <input type="text" value="{{$produits->new_prix}}" id="new_prix"
                                    placeholder="Nouveau Prix" class="form-control" name="new_prix">
